     ...
     <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
               ...
               <div class="card-body">
                    <form method="POST" action="{{ route('announcedpuresults.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="party_abbreviation" type="text" class="form-control @error('party_abbreviation') is-invalid @enderror" name="party_abbreviation" value="{{ old('party_abbreviation') }}" required autocomplete="party_abbreviation" autofocus>
